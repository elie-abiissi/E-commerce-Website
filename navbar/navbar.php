...
<?php session_start(); ?>
<body>
<!--Beginning of the top container-->
  <div id="headerimg">
  ...
  <!--Beginning of the header div-->
  <div id="header">
    <!--Beginning of the navigation bar-->
    <div class="topnav" id="myTopnav">
      <!--Beginning of home item-->
      <a href="../mainpage/mainpage.php" class="active">
        <i>
      ...
      <!--Beginning of button item-->
      <a class="icon" onclick="myNavBar()">
        <i>
          <svg id="d1" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            <path
