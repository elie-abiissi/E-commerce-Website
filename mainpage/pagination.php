...
$page_query = "SELECT * FROM products where idcategorie = $cat";  
 ...
 p.idcategorie = c.idcategorie and c.idcategorie = $cat ORDER BY p.idproduct asc LIMIT $start_from, $record_per_page";
 ...
 {   
    ...
    if($index%4 ==0 && $index>0){
     ...
     if($index%2==0)$output .= '<div id="mini">';
      ...
      if($row['stock']==0) {$output .= "<td class='empty'>Out Of Stock<svg  width='25px' height='25px' fill='white'  viewBox='0 0 16 16'>
