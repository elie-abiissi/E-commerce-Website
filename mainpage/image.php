...
$output ='<div id="main_div_container">';
$output .='<div id="mini">';
...
$output .= "<input type='text' class='number' value='1' readonly id='quant'>";
...
$output .="<a href='loadcategories.php?cat=".$cat."&page=".$page."'><svg class='svg'  width='25' height='25' fill='#068da5' viewBox='0 0 16 16'>
