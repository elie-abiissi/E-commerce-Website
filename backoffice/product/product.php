         ...
         <div id="content">
               ...
               <form method="POST" action="addproduct.php" enctype="multipart/form-data">
                  <fieldset id="add">
                     ...
                     <table>
                        <tr>
                           <td>Product Name</td>
                           <td><input type="text" name="prod_name" id="name"></td>
                        </tr>
                        <tr>
                           <td>Image (.jpg only)</td>
                           <td><input type="hidden" name="MAX_FILE_SIZE" value="300000000" /><input type="file" name="prod_photo" accept=".jpg"></td>
                        </tr>
                        <tr>
                           <td>Description</td>
                           <td> <textarea id="text" name="description" placeholder="Each sentence must end with a point(.)"></textarea></td>
                        </tr>
                        <tr>
                           <td>
                              Price
                           ...
                           <td>
                              <input type='text' name='price' id="price" placeholder="0000.00">
                           </td>
                        </tr>
                        <tr>
                           <td>Stock</td>
                           <td>
                              <input type='number' name='stock' min="1" id="number" value="1">
                           </td>
                        </tr>
                        <tr>
                           <td>
                        ...
                        <?php
                           if(isset($_GET['addprod'])&& !empty($_GET['addprod'])){
            ...
            <div id="center_div">
               <fieldset id="update">
                  ...
                  <div id="center_top">
                     <table class="mytab">
                        <?php echo load_products("Update","updateproduct.php") ?>
                     </table>
                  </div>
                  <?php
                     if(isset($_GET['updateprod'])&& !empty($_GET['updateprod'])){
                        echo "<div id='msg'>";
                        echo $_GET['updateprod'];
                        echo "</div>";
                     }
            ...
            <div id="bottom_div">
               <fieldset>
                  ...
                  <div id="bottom_top">
                     <table class="mytab">
                        <?php echo load_products("Delete","deleteproduct.php") ?>
                     </table>
                  </div>
                  <?php
                     if(isset($_GET['productdeleted'])&& !empty($_GET['productdeleted'])){
                        echo "<div id='msg'>";
                        echo $_GET['productdeleted'];
                        echo "</div>";
                     }
   ...
   $counter = 0;
     ...
     $creation.= "</select>";
       return $creation;
             ...
             function load_products($update,$page){
                 $counter = 0;
               $link = mysqli_connect ('localhost', 'root', '','web3_project')
               or die(mysqli_connect_errno()." : ".mysqli_connect_error ( ));
               $output= "<tr>";
                   $output.= "<th colspan='2'>Product Name</th>";
                  
                   
                   $output.= "</tr><tr>";
               $query = "SELECT idproduct, name, idcategorie FROM PRODUCTS";
               $result = mysqli_query($link,$query);
               while($ligne = mysqli_fetch_assoc($result)){
                   $output.= "</tr><tr>";
                  $output.= "<td>";
                   $output.= "<a href='".$page."?id=".$ligne['idproduct']."'>"."<button id='".$ligne['idproduct']."' class='".$ligne['idcategorie']." button'>".$update." ".ucfirst($ligne['name'])."</button></a>";
                   $output.= "</td>";
                   $counter++;
                }
                $output.= "</tr>";
